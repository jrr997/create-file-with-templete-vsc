...
class TemplateManager {
  ...
  private _findTemplate(normalizedPath: string, templates: ITemplates, templateDir: string) {
  ...
  public findTemplate(normalizedPath: string ) {
    return this._findTemplate(normalizedPath, this.userTemplates, this.templateDir) || this._findTemplate(normalizedPath, this.internalTemplates, path.join(__dirname, 'template'));
  }
}
